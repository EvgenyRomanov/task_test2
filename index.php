 ...
 * @param string[] $popularCrawlers
 * @return string
 */
function parsingAccessLog(string $relativePath, array $popularCrawlers = ['Google', 'Bing', 'Baidu', 'Yandex']): string {
    $result = [];
...
echo '<pre>';
echo parsingAccessLog('test.txt');
echo '</pre>';
